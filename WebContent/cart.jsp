					...
					<c:forEach items="${sessionScope.orderMap.values()}"
						...
						<tr>
							...
							<td class="col-sm-1 col-md-1" style="text-align: center;"><input
								...
								placeholder="1" value="${orderItem.quantity}" />
							</td>
							<!-- Delete button -->
				...
				<div class="card">
					...
					<form action="<%=path%>/Cart" method="post">
						<input type="hidden" name="productName"
							...
							value="<%=prodObj.getImage()%>"> <input type="hidden"
							name="productPrice" value="<%=prodObj.getPrice()%>"> <input
							type="hidden" name="productBrand"
							value="<%=prodObj.getManufacturer()%>"> <input
							type="hidden" name="productInventory"
