...
public class ProductDaoImpl implements ProductDao{
	...
	public Product getById(String id) {
		...
		try {
			ps = conn.prepareStatement(sql);
			rs = ps.executeQuery();
			if(rs.next())return new Product(rs.getString("id"), rs.getString("productName"), rs.getDouble("price"), rs.getString("image"), rs.getString("manufacturer"), rs.getString("productCondition"), rs.getDouble("discount"), rs.getString("catagory"), rs.getInt("inventory"));
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public List<Product> getProductByCatagory(String catagory) {
		...
		try {
			...
			rs = ps.executeQuery();
			while(rs.next()) {
				Product p = new Product(rs.getString("id"), rs.getString("productName"), rs.getDouble("price"), rs.getString("image"), rs.getString("manufacturer"), rs.getString("ProductCondition"), rs.getDouble("discount"), rs.getString("catagory"), rs.getInt("inventory"));
				list.add(p);
			}
		} catch (SQLException e) {
			// TODO Auto-generated catch block
